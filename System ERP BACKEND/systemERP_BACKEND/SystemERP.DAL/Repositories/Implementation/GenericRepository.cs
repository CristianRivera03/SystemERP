...
namespace SystemERP.DAL.Repositories.Implementation
{
    public class GenericRepository<TModel> : IGenericRepository<TModel> where TModel : class
    {
        private readonly SystemErpDbContext _dbcontext;

        public GenericRepository(SystemErpDbContext dbcontext)
        {
