  ...
  template: `
    <div class="ibm-container">
      <div class="ibm-header">
        <div>
          <h1 class="ibm-title">Traslados de Inventario</h1>
          <p class="ibm-subtitle">Movimiento de existencias entre sucursales, bodegas y ubicaciones</p>
        </div>
      </div>
      ...
      <div class="under-construction-card">
        ...
        <p class="description">
          Gestión de guías de remisión, transferencias entre almacenes y confirmación de recepción en destino.
        </p>
