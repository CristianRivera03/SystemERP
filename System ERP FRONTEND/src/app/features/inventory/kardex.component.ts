  ...
  template: `
    <div class="ibm-container">
      <div class="ibm-header">
        <div>
          <h1 class="ibm-title">Kardex de Movimientos</h1>
          <p class="ibm-subtitle">Historial detallado de entradas, salidas y saldos valorizados de inventario</p>
        </div>
      </div>
      ...
      <div class="under-construction-card">
        ...
        <p class="description">
          Reporte de Kardex PMP (Promedio Ponderado) y PEPS (Primeras Entradas, Primeras Salidas) por producto.
        </p>
