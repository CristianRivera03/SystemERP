  ...
  template: `
    <div class="ibm-container">
      <div class="ibm-header">
        <div>
          <h1 class="ibm-title">Asignación de Precios</h1>
          <p class="ibm-subtitle">Definición de márgenes de ganancia, listas de precios y tarifas por cliente/sucursal</p>
        </div>
      </div>
      ...
      <div class="under-construction-card">
        ...
        <p class="description">
          Configuración de listas de precios mayorista, al detalle y reglas de margen sobre costo.
        </p>
...
export class PriceAssignmentComponent {}
