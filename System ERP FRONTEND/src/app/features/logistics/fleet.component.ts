  ...
  template: `
    <div class="ibm-container">
      <div class="ibm-header">
        <div>
          <h1 class="ibm-title">Flota y Conductores</h1>
          <p class="ibm-subtitle">Control de vehículos de reparto, asignación de motoristas y manifiestos de carga</p>
        </div>
      </div>
      ...
      <div class="under-construction-card">
        ...
        <p class="description">
          Seguimiento de rutas de despacho, mantenimiento preventivo de transporte y logística de entregas.
        </p>
