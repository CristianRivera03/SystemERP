  ...
  template: `
    <div class="ibm-container">
      <div class="ibm-header">
        <div>
          <h1 class="ibm-title">Módulo de Ventas</h1>
          <p class="ibm-subtitle">Gestión de facturación, punto de venta y comprobantes fiscales</p>
        </div>
      </div>
      ...
      <div class="under-construction-card">
        ...
        <p class="description">
          Este módulo está preparado para integrarse con el motor de facturación electrónica y punto de venta.
        </p>
