  ...
  template: `
    <div class="ibm-container">
      <div class="ibm-header">
        <div>
          <h1 class="ibm-title">Cotizaciones de Ventas</h1>
          <p class="ibm-subtitle">Gestión de proformas, presupuestos para clientes y vigencia de precios</p>
        </div>
      </div>
      ...
      <div class="under-construction-card">
        ...
        <p class="description">
          El módulo de cotizaciones a clientes se encuentra en fase de diseño de plantillas e impresión PDF.
        </p>
