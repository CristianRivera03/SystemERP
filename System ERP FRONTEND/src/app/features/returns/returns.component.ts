  ...
  template: `
    <div class="ibm-container">
      <div class="ibm-header">
        <div>
          <h1 class="ibm-title">Módulo de Devoluciones</h1>
          <p class="ibm-subtitle">Gestión de notas de crédito, devoluciones de ventas e incidencias con proveedores</p>
        </div>
      </div>
      ...
      <div class="under-construction-card">
        ...
        <p class="description">
          Reingreso de mercancía por garantía, notas de crédito a clientes y reajuste de stock defectuoso.
        </p>
