  ...
  template: `
    <div class="ibm-container">
      <div class="ibm-header">
        <div>
          <h1 class="ibm-title">Cotizaciones de Compra</h1>
          <p class="ibm-subtitle">Solicitud de cotizaciones y cuadros comparativos de precios de proveedores</p>
        </div>
      </div>
      ...
      <div class="under-construction-card">
        ...
        <p class="description">
          Módulo para gestión de RFQs y cuadros comparativos de adquisición.
        </p>
...
export class PurchaseQuotesComponent {}
