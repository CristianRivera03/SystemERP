  ...
  template: `
    <div class="ibm-container">
      <div class="ibm-header">
        <div>
          <h1 class="ibm-title">Módulo de Retaceo (Costos de Importación)</h1>
          <p class="ibm-subtitle">Distribución de fletes, aranceles y gastos de importación sobre el costo de inventario</p>
        </div>
      </div>
      ...
      <div class="under-construction-card">
        ...
        <p class="description">
          Módulo especializado para prorrateo de costos de importación y cálculo del Costo Landed exacto.
        </p>
