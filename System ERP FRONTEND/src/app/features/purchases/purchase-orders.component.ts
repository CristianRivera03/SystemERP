  ...
  template: `
    <div class="ibm-container">
      <div class="ibm-header">
        <div>
          <h1 class="ibm-title">Órdenes de Compra</h1>
          <p class="ibm-subtitle">Emisión y seguimiento de órdenes oficiales a proveedores</p>
        </div>
      </div>
      ...
      <div class="under-construction-card">
        ...
        <p class="description">
          Gestión de flujo de aprobación de órdenes de compra y fechas de recepción estimadas.
        </p>
